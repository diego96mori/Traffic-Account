...
useEffect(() => {
    ...
    const datosOLTProvincia = datos.filter(
        item => item.grupo === "OLT PROVINCIA"
    );
        ...
        <div className="dashboard-layout">
            ...
            <main className="dashboard-content">
                ...
                <div className="filters-container">
                    ...
                    >
                        <ReportePDF
                            datos={datosOLTProvincia}
                            titulo="Reporte de Trafico - OLT Provincia"
                            nombreArchivo="Reporte_OLT_Provincia"
