...
function NodosProvincia() {
    ...
    const datosNodosProvincia = datos.filter(
        item => item.grupo === "NODOS PROVINCIA"
    );
...
const datosGrafico =
    datosNodosProvincia.filter(item => {
        ...
        <div className="dashboard-layout">
            ...
            <main className="dashboard-content">
                ...
                <div className="filters-container">
                    ...
                    >
                        <ReportePDF
                            datos={datosNodosProvincia}
                            titulo="Reporte de Trafico - Nodos Provincia"
                            nombreArchivo="Reporte_Nodos_Provincia"
