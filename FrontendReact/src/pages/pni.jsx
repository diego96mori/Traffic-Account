...
useEffect(() => {
    ...
    const datosPNI = datos.filter(
        item => item.grupo === "TRAFICO PNI"
    );
    ...
    const datosGrafico = datosPNI.filter(item => {
            ...
            <main className="dashboard-content">
                ...
                <div className="filters-container">
                    ...
                    >
                        <ReportePDF
                            datos={datosPNI}
                            titulo="Reporte de Trafico - PNI"
                            nombreArchivo="Reporte_PNI"
                        />
                    </div>
