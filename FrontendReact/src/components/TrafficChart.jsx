 ...
 //=========================
  ...
  const leyendaUso = (
    ...
    >
      ...
      >
        <span style={{ background: "repeating-linear-gradient(to right, #00c853 0 4px, #ffffff 4px 8px)" }} />
        <span style={{ background: "repeating-linear-gradient(to right, #ffb300 0 4px, #ffffff 4px 8px)" }} />
        <span style={{ background: "repeating-linear-gradient(to right, #ff1744 0 4px, #ffffff 4px 8px)" }} />
      </div>
